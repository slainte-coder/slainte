...
# $Revision: 247 $
# $Author: alfred $
# $HeadURL: https://monitoring.slainte.at/svn/slainte/trunk/scripts/dump_mariadb.sh $
# $Id: dump_mariadb.sh 247 2021-02-09 08:41:30Z alfred $
# Dumpen (von aussen) der Inhalte der Maria-DB
#
# $0 /opt/containers/joomla/docker-compose.yml
#
############################################################################################
